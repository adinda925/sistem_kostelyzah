...
class TransaksiModel extends Model
{
    ...
    protected $allowedFields = [
        'id_kamar', 'id_user', 'nama', 'email', 'no_wa', 'no_kamar', 'biaya', 'bulan', 'tgl_masuk', 'order_id', 'payment_type', 'payment_method', 'created_by', 'created_date', 'transaction_time', 'transaction_status', 'va_number', 'bank', 'pdf_url'
    ];
