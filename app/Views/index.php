        ...
        <div class="row features-inner">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-features">
                    <i class="fa-solid fa-motorcycle" style="font-size: xx-large;margin-bottom: 20px;"></i>
                    <h6>Parkiran Motor</h6>
                    <p>Tersedia Parkiran Motor</p>
                </div>
            </div>
            <!-- single features -->
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-features">
                    <i class="fa-solid fa-bed" style="font-size: x-large;margin-bottom: 20px;"></i>
                    <h6>Kasur dan Lemari</h6>
                    <p>Mendapatkan Kasur dan Lemari</p>
                </div>
            </div>
            <!-- single features -->
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-features">
                    <i class="fa-solid fa-bath" style="font-size: xx-large;margin-bottom: 20px;"></i>
                    <h6>Kamar Mandi</h6>
